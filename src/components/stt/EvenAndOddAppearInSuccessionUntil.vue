<template>
	<div class="EvenAndOddAppearInSuccessionUntil">
		<div class="accordion accordion-area">

			<div class="accordion-header" @click="toggleAccordion">
				<label class="label-medium">짝수/홀수 현재까지 연속 등장 횟수</label>
...
<script setup>
	...
	const appearInSuccessionUntil = () => {
		...
		return drwStore.getEvenAndOddAppearInSuccessionUntil(draws); // 연속 등장 횟수 계산
	};
