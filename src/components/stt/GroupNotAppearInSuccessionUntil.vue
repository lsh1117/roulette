<template>
	<div class="GroupNotAppearInSuccessionUntil">
		<div class="accordion accordion-area">

			<div class="accordion-header" @click="toggleAccordion">
				<label class="label-medium">구간별 현재까지 연속 미등장 횟수</label>
...
<script setup>
	...
	const notAppearInSuccessionUntil = () => {
		...
		return drwStore.getGroupNotAppearInSuccessionUntil(draws); // 연속 등장 횟수 계산
	};
