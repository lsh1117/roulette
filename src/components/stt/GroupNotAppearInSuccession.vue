<template>
	<div class="GroupNotAppearInSuccession">
		<div class="accordion accordion-area">

			<div class="accordion-header" @click="toggleAccordion">
				<label class="label-medium">구간별 연속 미등장 횟수</label>
...
<script setup>
	...
	const appearInSuccession = () => {
		...
		return drwStore.getGroupNotAppearInSuccession(draws); // 연속 미등장 횟수 계산
	};

	// 미등장 횟수를 반응형 데이터로 관리 (내림차순 정렬 추가)
